document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    ...
    try {
      ...
      if (currentDifficulty && currentDifficulty !== "all-without-difficulty") {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficulty === "all-without-difficulty") {
        // Show only activities that don't have a difficulty specified
        if (details.difficulty) {
          return;
        }
      }
      // Note: Other difficulty filters are handled server-side in fetchActivities
